...
//$requestObject->profilePassword second argument from line 74
	...
	$profile = new Profile(null, $profileActivationToken, $requestObject->profileEmail, $requestObject->profileFirstName,$profileHash,$requestObject->profileLastName, $requestObject->profilePhonNumber, $profileSalt,  null,  $requestObject->profileType,$requestObject->profileUserName);
	$profile->insert($pdo);
	//reply message
