...
class PurchaseTest extends RootsTableTest {
	...
	/**
	 * String generated by a second transaction
	 * @var string $purchaseStripeToken2
	 */
	protected $purchaseStripeToken2 = "tok_18hQmK2eZvKYlo2SILNY5nTJ";
	/**
...
// create and insert a Profile to own the test Purchase
	...
	public function testUpdateValidPurchase() {
		...
		$purchase->setPurchaseStripeToken($this->purchaseStripeToken2);
