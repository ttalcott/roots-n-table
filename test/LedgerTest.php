...
class LedgerTest extends RootsTableTest {
	...
	**/
	protected $VALID_STRIPE = "tok_18hQmK2eZvKYlo2CSILNY5nA";
	/**
	...
	**/
	protected $VALID_STRIPEPURCHASE = "tok_18hQmK2eZvKYlo2CSILNY5nB";
	/**
	...
	**/
	public function testGetInvalidLedgerByLedgerStripeToken() {
		...
		$ledger = Ledger::getLedgerByLedgerStripeToken($this->getPDO(), "2");
		$this->assertNull($ledger);
	}
